...
def generate_log(current_time, burst_mode, incident_service, outage_rules):
    ...
    return (
        ...
        f"incident_service={incident_service if incident_service else 'none'} "
        f"incident_type=\"{incident_type if incident_type else 'none'}\" "
        f"{message}"
    )
...
log_file = "application.log"
        ...
        #Debug lines to confirm incendents look realistic
incident_flag = "false"
incident_type = None

if incident_service:
  incident_flag = "true"
  incident_type = outage_rules.get(incident_service, {}).get("error")
